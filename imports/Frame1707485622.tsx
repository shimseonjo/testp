...
/**
 * Frame1707485622 - bODYFENCE 스플래시 스크린 컴포넌트
 * Walk Safe, Live Smart 슬로건과 함께 앱 로고를 표시
 */
export default function Frame1707485622() {
  return (
    <div className="absolute bg-[#2260ff] left-0 rounded-[30px] top-0 w-[360px] h-[800px]" data-name="splash Screen">
