...
function Icon() {
  return (
    <div
      className="absolute h-[38px] left-[9px] top-[7px] w-[42px]"
      data-name="Icon"
    >
      <div className="absolute bottom-[-18.421%] left-[-7.143%] right-[-16.667%] top-[-10.526%]">
        <svg
...
export default function Frame1707485624() {
  return (
